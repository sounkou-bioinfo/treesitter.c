...
## Advanced: Preprocessing with fake libc and no standard includes

You can use the `preprocess_header` function with extra compiler options to avoid system includes and use the bundled fake libc headers. This is useful for portable parsing and avoiding system-specific macros.
...
The following concise examples demonstrate extracting specific information (functions, parameters, structs, macros) using the API.
